defmodule WCore.Application do
  ...
  def start(_type, _args) do
    children = [
      ...
      {Finch, name: WCore.Finch},
      {Phoenix.PubSub, name: WCore.PubSub},
      # Telemetry OTP layer: TelemetryServer (ETS) + WriteBehindWorker (SQLite sync)
      # Must start after PubSub (broadcasts) and Repo (warm-up from DB)
